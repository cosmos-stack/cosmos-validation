...
{
    [Trait("TokenUT", "ValueNotInTokenTests")]
    public class ValueNotInTokenTests
    {
        ...
        public void AunnCoo_List_For_NotInToken_And_ShouldBeValid()
        {
            ...
            var token = new ValueNotInToken(contract, new List<object> {"Bad", "Duo", "Long"});
        ...
        public void AunnCoo_List_For_GenericNotInToken_And_ShouldBeValid()
        {
            ...
            var token = new ValueNotInToken<List<string>, string>(contract, new List<string> {"Bad", "Duo", "Long"});
        ...
        public void AunnCoo_List_For_GenericNotInToken_And_ShouldBeInvalid()
        {
            ...
            var token = new ValueNotInToken<List<string>, string>(contract, new List<string> {"Nice", "Duo", "Long"});
        ...
        public void AunnCoo_One_For_GenericNotInToken_And_ShouldBeValid()
        {
            ...
            var token = new ValueNotInToken<string>(contract, new List<string> {"Nice", "Duo", "Long", "Niu"});
        ...
        public void AunnCoo_One_For_GenericNotInToken_And_ShouldBeInvalid()
        {
            ...
            var token = new ValueNotInToken<string>(contract, new List<string> {"Bad", "Duo", "Long", "N"});
