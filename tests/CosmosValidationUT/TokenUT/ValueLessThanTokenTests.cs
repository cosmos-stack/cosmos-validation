...
namespace CosmosValidationUT.TokenUT
{
    ...
    public class ValueLessThanTokenTests
    {
        ...
        [Fact]
        public void AunnCoo_ValueType_For_GenericLessThanToken_And_ShouldBeValid()
        {
            var model = new AunnCoo {Age = 10};
            ...
            var token = new ValueLessThanToken<int>(contract, 11);
        ...
        [Fact]
        public void AunnCoo_ValueType_For_GenericLessThanToken_And_ShouldBeInvalid()
        {
            var model = new AunnCoo {Age = 10};
            ...
            var token = new ValueLessThanToken<int>(contract, 10);
