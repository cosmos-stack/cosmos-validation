...
{
    internal abstract class ValueRequiredBasicToken<TVal> : ValueToken<TVal>
    {
        ...
        protected abstract bool IsValidImpl(TVal value);
        ...
        protected abstract string GetDefaultMessageSinceToken(TVal obj);
    }
}