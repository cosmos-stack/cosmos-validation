...
{
    internal class ValueGreaterThanToken : ValueToken
    {
        // ReSharper disable once InconsistentNaming
        public const string NAME = "ValueGreaterThanToken";

        private readonly object _valueToCompare;
        private readonly Type _typeOfValueToCompare;

        public ValueGreaterThanToken(VerifiableMemberContract contract, object valueToCompare) : base(contract)
        {
