...
{
    public static class ValueValidationRegistrarExtensions
    {
        private static ValueValidationRegistrar<T, TVal> _impl<T, TVal>(this IValueFluentValidationRegistrar<T, TVal> builder)
        {
            return (ValueValidationRegistrar<T, TVal>) builder;
        }

        private static ValueValidationRegistrar<T> _impl<T>(this IValueFluentValidationRegistrar<T> builder)
        {
            return (ValueValidationRegistrar<T>) builder;
        }

        private static ValueValidationRegistrar _impl(this IValueFluentValidationRegistrar builder)
        {
