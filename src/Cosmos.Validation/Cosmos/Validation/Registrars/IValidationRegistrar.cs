...
namespace Cosmos.Validation.Registrars
{
    ...
    {
        IValidationRegistrar ForStrategy<TStrategy>(StrategyMode mode = StrategyMode.OverallOverwrite) 
            where TStrategy : class, IValidationStrategy, new();
        IValidationRegistrar ForStrategy<TStrategy, T>(StrategyMode mode = StrategyMode.OverallOverwrite) 
        ...
        IValidationRegistrar ForStrategy<TStrategy>(string name, StrategyMode mode = StrategyMode.OverallOverwrite)
            where TStrategy : class, IValidationStrategy, new();
        IValidationRegistrar ForStrategy<TStrategy, T>(string name, StrategyMode mode = StrategyMode.OverallOverwrite) 
            where TStrategy : class, IValidationStrategy<T>, new();
        ...
        IValidationRegistrar ForValidator<TValidator>() 
            where TValidator : CustomValidator, new();
        IValidationRegistrar ForValidator<TValidator, T>()
            where TValidator : CustomValidator<T>, new();
