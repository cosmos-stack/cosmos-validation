...
namespace Cosmos.Validation.Internals
{
    internal static class Assists
    {
        ...
        public static bool ValidLength(string idNumber, ChinaIdNumberValidationOptions options, List<VerifyFailure> failures, ChinaIdNumberInfo info)
        {
        ...
        public static bool ValidBirthday(string idNumber, ChinaIdNumberValidationOptions options, List<VerifyFailure> failures, ChinaIdNumberInfo info)
        {
            return X(options).ValidBirthday(idNumber, options, failures, info);
        }

        public static bool ValidArea(string idNumber, ChinaIdNumberValidationOptions options, List<VerifyFailure> failures, ChinaIdNumberInfo info)
        {
            return X(options).ValidArea(idNumber, options, failures, info);
        }
        
        public static bool ValidCheckBit(string idNumber, ChinaIdNumberValidationOptions options, List<VerifyFailure> failures, ChinaIdNumberInfo info)
        {
            return X(options).ValidCheckBit(idNumber, options, failures, info);
        }

        public static bool ValidTheRest(string idNumber, ChinaIdNumberValidationOptions options, List<VerifyFailure> failures, ChinaIdNumberInfo info)
        {
